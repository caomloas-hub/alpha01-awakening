...
image town cg roadside_map = Transform("images/town_route/cg/cg-town-roadside-map-lan-v1.png", xysize=(1920, 1080))
...
image town_paw pointer = "images/town_route/map/paw-lan-map-pointer-v3.png"
...
transform town_paw_enter_city:
    ...
    ypos 0.313
    alpha 0.0
    easeout 0.65 xpos 0.778 alpha 1.0
...
transform town_paw_to_road:
    ...
    xpos 0.778
    ypos 0.313
    easein 0.85 xpos 0.238 ypos 0.790
...
transform town_paw_back_to_city:
    ...
    xpos 0.238
    ypos 0.790
    easein 0.90 xpos 0.778 ypos 0.313
