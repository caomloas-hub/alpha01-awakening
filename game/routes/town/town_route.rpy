...
label town_t01_tracks:
    ...
    menu:
        "保持距离，先数清人数":
            ...
            "看站位，像是领队、车把式和记账员。武器都收在手边，没有谁拔出来。"
        ...
        "观察车辆和路面" if tech_insight >= 2:
            ...
            "车轮每转一圈，裂纹都会再张开一点。照这个速度，它撑不过下一个急弯。"
...
label town_t02_broken_axle:
    ...
    ao "[player_name]。"
    taosui "从哪来？"
    "我没有能说出口的地名。短暂的沉默已经让他们重新握紧了货箱边的木棍。"
...
label town_t03_cover_and_clothes:
    ...
    taosui "先给十二枚。车送进门，再给十三枚。"
    ao "成交。"
    "陶穗数出十二枚铜币。我攥在手里，又摊开数了一遍，才收进口袋。"
    $ caravan_trust += 1
    ...
    lan "你没有行脚牌，口音也生。就说北岭旧道塌方，和同行者失散，行李、文书都没带出来。"
    ao "他们查不出来？"
    ...
    menu:
        ...
        "先让岚解释每个证件词的含义":
            ...
            "这些凭证都要写来处、亲族和做过的事。我低头看着那张空白雇签，一栏也填不出来。"
    ...
    ao "能改吗？"
    lan "能。别乱动。"
    "他伸手比量后腰的位置。我看见他另一只手里的剪刀，本能地向前挪了半步。"
    lan "我还没碰到你。"
    ao "身体自己躲的。"
    "岚看了我一眼，把剪刀放下，先在布上做了记号。"
    "等我脱下工作衣，他才把它背面朝上摊平，沿记号剪开尾孔，又把边缘缝牢。"
...
label town_t05_gate:
    ...
    "旧混凝土没有被拆掉。新砌的门洞、木架和岗台直接压在它上面，裂缝里还长着草。"
    ...
    ao "[player_name]。"
    wence "籍贯。"
    "我知道这两个字的意思。问题是，我能报出的地名早已不在他们的地图上。"
    ...
    if old_world_exposure >= 1:
        ...
        wence "没有文书，你以前做什么，我在这里核不了。今天的事得有人作证。"
    heng "断轴是他帮着稳的。今天的活，我作证。"
    ...
    "穿过冷暗门洞的一瞬间，晚霞晃进眼里。叫卖和车轮声从四面围上来，岚说的话也听不清了。"
    "岚走出几步，又回头确认我是否跟上。陶穗已经领着货车进入外市的人流。"
    "我握紧刚盖过章的木牌。掌心能完全遮住它。下一道盘问再来时，我终于有东西可以递出去。"
...
label town_t06_south_yard:
    ...
    "一个长尾的行人侧身让我过去。我还在看那处斜槽，差点挡住身后的货车。"
    ...
    taosui "门外给了十二枚。这里十三枚，你数清楚。"
    "我把先前的铜币也拿出来，合在一起，正好二十五枚。梅婶当面取走两枚押金，剩下的推给我。"
    $ town_permit = True
    $ town_money = 23
    ...
    "陶穗只说了明早卸货的时辰，便转身去核对入库数量。她没有催我留下，也没有收回已经办好的短籍。"
    taosui "明早愿意继续干活，就按南栈院的日价算。不愿意，短籍也仍然有效。"
    ao "我记住了。"
    taosui "你把车送进来，我们把你送进来。今天的账，到这里就平了。"
    "我数了一遍剩下的铜币，没有少。陶穗已经走到下一辆车旁，低头核对新的货单。"
...
label town_t07_lamplight:
    ...
    menu:
        ...
        "反问他为什么愿意担风险":
            ...
            lan "没有好处。写错了还要挨陶姐骂。"
            lan "我第一次到灰桥时也没有保人。在西关道外坐了两天，晚上只能靠着货棚睡。"
            lan "第三天陶姐缺一个识字的跑腿，才把我的名字添进货册。"
            lan "今天看见你站在车边，我想起那两天。就这样，没别的。"
            "我看着桌上的短籍牌。边角还带着新削木头的毛刺。"
            ao "谢谢。"
            "岚把视线转向桌上的灯。"
            lan "明天一起搬货。你扶底下，我来搭手。"

    "岚把灯芯拨低，走到门口时又停了一下。"
    lan "明早我来叫你。钱收好，别跟换下来的衣服一起送去洗了。"
    ao "收好了。我等你。"
    lan "那明早见。"
    "门关上以后，房间里仍有车轮、脚步和隔墙说话的声音。"
    "地下设施的安静意味着没有人活着。这里的吵闹却让人知道，墙外总有谁会在下一刻咳嗽、抱怨，或者喊出另一个人的名字。"
    "我把短籍牌压在枕边。明早要认铜币，还要卸货。灯灭以前，我第一次知道醒来后的第二天该做什么。"
