...
define gui.accent_color = '#3edcff'

## The color used for a text button when it is neither selected nor hovered.
define gui.idle_color = '#b8c7dc'

## The small color is used for small text, which needs to be brighter/darker to
## achieve the same effect.
define gui.idle_small_color = '#8ea7c4'

## The color that is used for buttons and bars that are hovered.
define gui.hover_color = '#7cecff'
...
define gui.insensitive_color = '#6d7f997f'

## Colors used for the portions of bars that are not filled in. These are not
## used directly, but are used when re-generating bar image files.
define gui.muted_color = '#164b69'
define gui.hover_muted_color = '#247b9c'
...
define gui.main_menu_background = Transform("gui/main_menu.png", xysize=(1920, 1080))
define gui.game_menu_background = Transform("gui/game_menu.png", xysize=(1920, 1080))

## The color of the main menu.
define gui.main_menu_text_color = "#7cecff"
...
define gui.choice_button_borders = Borders(90, 18, 90, 18)
...
## speaking character.
define gui.history_name_xpos = 225
